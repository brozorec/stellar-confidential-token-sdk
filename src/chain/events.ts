 ...
 * the central, deliberate limitation of this design.
 *
 ...
 * The data keys below are the contract's struct field names verbatim — verify them
...
/**
 * Event reference: pins one on-chain event.
 ...
 * never part of any proof's public inputs (disclosure/verify.ts).
 */
 ...
 * ledger has aged out of the RPC's ~7-day retention window — an accepted
 * limitation of this design. The disclosure verifier (disclosure/verify.ts)
